...
public class ProgramDAO {
    private static final String SELECT_ALL_PROGRAMS = "SELECT * FROM movies_db.public.films";
    private static final String INSERT_PROGRAM = "INSERT INTO movies_db.public.films (title, channel, genre, day_of_week, start_time) VALUES (?, ?, ?, ?, ?)";
    private static final String UPDATE_PROGRAM = "UPDATE movies_db.public.films SET title = ?, channel = ?, genre = ?, day_of_week = ?, start_time = ? WHERE id = ?";
    private static final String DELETE_PROGRAM = "DELETE FROM movies_db.public.films WHERE id = ?";
